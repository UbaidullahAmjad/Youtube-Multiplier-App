...
<div class="card border-primary">
  ...
  <div class="col"><a href="latestviewall.php?split=2" class="btn btn-success">View All</a></div></div></h2></div>
...
<div class="card border-primary">
  ...
  <div class="col"><a href="latestviewall.php?split=3"  class="btn btn-success">View All</a></div></div></h2></div>
...
<div class="card border-primary">
  ...
  <div class="col"><a href="latestviewall.php?split=4"  class="btn btn-success">View All</a></div></div></h2></div>
<div class="w3-content w3-display-container">
<div class="row"  style="  padding: 15px 15px 15px 15px;">
...
<div class="card border-primary">
  ...
  <div class="col"><a href="latestviewall.php?split=5"  class="btn btn-success">View All</a></div></div></h2></div>
...
<div class="card border-primary">
  ...
  <div class="col"><a href="latestviewall.php?split=6"  class="btn btn-success">View All</a></div></div></h2></div><div class="w3-content w3-display-container">
<div class="row"  style="  padding: 15px 15px 15px 15px;">
<?php
if(!empty($_SESSION['id'])){
  if($age>=18){
...
<div class="card border-primary">
  ...
  <div class="col"><a href="latestviewall.php?split=7"  class="btn btn-success">View All</a></div></div></h2></div>
<div class="w3-content w3-display-container">
<div class="row"  style="  padding: 15px 15px 15px 15px;">
<?php
    if(!empty($_SESSION['id'])){
...
<div class="card border-primary">
  ...
  <div class="col"><a href="latestviewall.php?split=8"  class="btn btn-success">View All</a></div></div></h2></div>
<div class="w3-content w3-display-container">
<div class="row"  style="  padding: 15px 15px 15px 15px;">
<?php
if(!empty($_SESSION['id'])){
