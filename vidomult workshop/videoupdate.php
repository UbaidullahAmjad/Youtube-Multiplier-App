...
if(isset($_POST['updatevideos'])){
  if(!empty($_SESSION['eurl1']) and empty($_SESSION['eurl2']) and empty($_SESSION['eurl3']) and empty($_SESSION['eurl4']) and empty($_SESSION['url5']) and empty($_SESSION['url6']) and empty($_SESSION['url7']) and empty($_SESSION['url8']) ){
    $singleurl=$_SESSION['eurl1'];
    $noOfVideos=1;
    //$urll=array(($_SESSION['url1']));
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and empty($_SESSION['eurl3']) and empty($_SESSION['eurl4']) and empty($_SESSION['eurl5']) and empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $singleurl=$_SESSION['eurl1']."$".$_SESSION['eurl2'];
    $noOfVideos=2;
    //$urll=array($_SESSION['url1'],$_SESSION['url2']);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and empty($_SESSION['eurl4']) and empty($_SESSION['eurl5']) and empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $singleurl=$_SESSION['eurl1']."$".$_SESSION['eurl2']."$".$_SESSION['eurl3'];
    $noOfVideos=3;
    //$urll=array($_SESSION['url1'],$_SESSION['url2'],$_SESSION['url3']);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and !empty($_SESSION['eurl4']) and empty($_SESSION['eurl5']) and empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $singleurl=$_SESSION['eurl1']."$".$_SESSION['eurl2']."$".$_SESSION['eurl3']."$".$_SESSION['eurl4'];
    $noOfVideos=4;
    //$urll=array($_SESSION['url1'],$_SESSION['url2'],$_SESSION['url3'],$_SESSION['url4']);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and !empty($_SESSION['eurl4']) and !empty($_SESSION['eurl5']) and empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $singleurl=$_SESSION['eurl1']."$".$_SESSION['eurl2']."$".$_SESSION['eurl3']."$".$_SESSION['eurl4']."$".$_SESSION['eurl5'];
    $noOfVideos=5;
    //$urll=array($_SESSION['url1'],$_SESSION['url2'],$_SESSION['url3'],$_SESSION['url4'],$_SESSION['url5']);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and !empty($_SESSION['eurl4']) and !empty($_SESSION['eurl5']) and !empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $singleurl=$_SESSION['eurl1']."$".$_SESSION['eurl2']."$".$_SESSION['eurl3']."$".$_SESSION['eurl4']."$".$_SESSION['eurl5']."$".$_SESSION['eurl6'];
    $noOfVideos=6;
    //$urll=array($_SESSION['url1'],$_SESSION['url2'],$_SESSION['url3'],$_SESSION['url4'],$_SESSION['url5'],$_SESSION['url6'],);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and !empty($_SESSION['eurl4']) and !empty($_SESSION['eurl5']) and !empty($_SESSION['eurl6']) and !empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $singleurl=$_SESSION['eurl1']."$".$_SESSION['eurl2']."$".$_SESSION['eurl3']."$".$_SESSION['eurl4']."$".$_SESSION['eurl5']."$".$_SESSION['eurl6']."$".$_SESSION['eurl7'];
    $noOfVideos=7;
    //$urll=array($_SESSION['url1'],$_SESSION['url2'],$_SESSION['url3'],$_SESSION['url4'],$_SESSION['url5'],$_SESSION['url6'],$_SESSION['url7'],);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['url2']) and !empty($_SESSION['url3']) and !empty($_SESSION['eurl4']) and !empty($_SESSION['eurl5']) and !empty($_SESSION['eurl6']) and !empty($_SESSION['eurl7']) and !empty($_SESSION['eurl8'])){
    $singleurl=$_SESSION['eurl1']."$".$_SESSION['eurl2']."$".$_SESSION['eurl3']."$".$_SESSION['eurl4']."$".$_SESSION['eurl5']."$".$_SESSION['eurl6']."$".$_SESSION['eurl7']."$".$_SESSION['eurl8'];
    $noOfVideos=8;
...
date_default_timezone_set('Asia/karachi');
 ...
 //Image Upload Code
   ...
   //$query=mysqli_query($con,"insert into videos values(null,'$userid','$singleurl','$title','$description','$tags','$restict','$imagefolder','$status','$dateS','$noOfVideos','0','0','0')");
   if($query){
     $a=5;
   }else{
                            ...
                            <div class="tab-pane active" id="Registration">
                               ...
                               <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label">
                                        Title</label>
                                    <div class="col-sm-10">
                                        <input type="text" value="<?php echo $row['title']?>" name="title" required class="form-control" id="email" placeholder="Title" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label">
                                        Description</label>
                                    <div class="col-sm-10">
                                        <textarea type="email" name="description" required class="form-control"  ><?php echo $row['description']?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="mobile" class="col-sm-2 control-label">
                                        Tags</label>
                                    <div class="col-sm-10">
                                        <input type="text" value="<?php echo $row['tags']?>" name="tag" required class="form-control" id="mobile" placeholder="Tags" />
                                    </div>
                                </div>
                                <div class="form-group">
  ...
  <input  type="file" id="Thumbnail"  name="thumbanil">
                    ...
                    <div class="col-md-4">
                        <div class="row text-center sign-with">
						 ...
						 <img id="thumbnailimg" src="<?php echo $row['thumbnail']?>" style="width:230px; height:230px; flex-wrap: wrap;  border-radius:15px;">
...
<div class="card border-primary " >
  <div class="card-header"><div class="float-right"><a id="clink" href="editvideo.php?vidID=<?php echo $vidID ?>"><img src="cross.ico"></a></div>
...
function onYouTubeIframeAPIReady() {
  <?php
  if(!empty($_SESSION['eurl1']) and empty($_SESSION['eurl2']) and empty($_SESSION['eurl3']) and empty($_SESSION['eurl4']) and empty($_SESSION['eurl5']) and empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8']) ){
    $urll=array(($_SESSION['eurl1']));
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and empty($_SESSION['eurl3']) and empty($_SESSION['eurl4']) and empty($_SESSION['eurl5']) and empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $urll=array($_SESSION['eurl1'],$_SESSION['eurl2']);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and empty($_SESSION['eurl4']) and empty($_SESSION['eurl5']) and empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $urll=array($_SESSION['eurl1'],$_SESSION['eurl2'],$_SESSION['eurl3']);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and !empty($_SESSION['eurl4']) and empty($_SESSION['eurl5']) and empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $urll=array($_SESSION['eurl1'],$_SESSION['eurl2'],$_SESSION['eurl3'],$_SESSION['eurl4']);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and !empty($_SESSION['eurl4']) and !empty($_SESSION['eurl5']) and empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $urll=array($_SESSION['eurl1'],$_SESSION['eurl2'],$_SESSION['eurl3'],$_SESSION['eurl4'],$_SESSION['eurl5']);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and !empty($_SESSION['eurl4']) and !empty($_SESSION['eurl5']) and !empty($_SESSION['eurl6']) and empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $urll=array($_SESSION['eurl1'],$_SESSION['eurl2'],$_SESSION['eurl3'],$_SESSION['eurl4'],$_SESSION['eurl5'],$_SESSION['eurl6'],);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and !empty($_SESSION['eurl4']) and !empty($_SESSION['eurl5']) and !empty($_SESSION['eurl6']) and !empty($_SESSION['eurl7']) and empty($_SESSION['eurl8'])){
    $urll=array($_SESSION['eurl1'],$_SESSION['eurl2'],$_SESSION['eurl3'],$_SESSION['eurl4'],$_SESSION['eurl5'],$_SESSION['eurl6'],$_SESSION['eurl7'],);
  }elseif(!empty($_SESSION['eurl1']) and !empty($_SESSION['eurl2']) and !empty($_SESSION['eurl3']) and !empty($_SESSION['eurl4']) and !empty($_SESSION['eurl5']) and !empty($_SESSION['eurl6']) and !empty($_SESSION['eurl7']) and !empty($_SESSION['eurl8'])){
    $urll=array($_SESSION['eurl1'],$_SESSION['eurl2'],$_SESSION['eurl3'],$_SESSION['eurl4'],$_SESSION['eurl5'],$_SESSION['eurl6'],$_SESSION['eurl7'],$_SESSION['eurl8'],);
  }
  //$urll=array($_SESSION['url1'],$_SESSION['url2'],$_SESSION['url3'],$_SESSION['url4'],$_SESSION['url5'],$_SESSION['url6'],$_SESSION['url7'],$_SESSION['url8']);
