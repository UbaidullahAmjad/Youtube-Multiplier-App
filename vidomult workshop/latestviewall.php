...
<div class="row">
       ...
       if(!empty($_SESSION['id'])){
         if($age>=18){
          $result_per_page=10 ;
          $query=mysqli_query($con,"select * from videos where noofvideos='2' and status='public' order by date  desc");
          ...
          $result=mysqli_query($con,"select * from videos where noofvideos='2' and status='public' order by date  desc limit ".$this_page_first_result.','.$result_per_page);
          if($result){
   ...
   <?php
          ...
          $result_per_page=10 ;
          $query=mysqli_query($con,"select * from videos where noofvideos='2' and status='public'  and restriction='under 18'  order by date  desc");
          ...
          $this_page_first_result=($page-1)*$result_per_page;
          $result=mysqli_query($con,"select * from videos where noofvideos='2' and status='public'  and restriction='under 18'  order by date  desc limit ".$this_page_first_result.','.$result_per_page);
          if($result){
           while($row=mysqli_fetch_array($result)){
           $thumbnail=$row['thumbnail'];
           $user_id=$row['user_id'];
...
<div class="row">
    ...
    $result_per_page=10;
    $query=mysqli_query($con,"select * from videos where noofvideos='3' and status='public' order by date  desc");
    ...
    $result=mysqli_query($con,"select * from videos where noofvideos='3' and status='public' order by date  desc limit ".$this_page_first_result.','.$result_per_page);
    if($result){
     while($row=mysqli_fetch_array($result)){
     $thumbnail=$row['thumbnail'];
     $user_id=$row['user_id'];
...
<?php
        ...
        $result_per_page=10;
      $query=mysqli_query($con,"select * from videos where noofvideos='3' and status='public' and restriction='under 18'  order by date  desc");
      ...
      $result=mysqli_query($con,"select * from videos where noofvideos='3' and status='public' and restriction='under 18'  order by date  desc limit ".$this_page_first_result.','.$result_per_page);
      if($result){
       while($row=mysqli_fetch_array($result)){
       $thumbnail=$row['thumbnail'];
       $user_id=$row['user_id'];
...
<div class="row">
    ...
    if(!empty($_SESSION['id'])){
      if($age>=18){
        $result_per_page=10;
        $query=mysqli_query($con,"select * from videos where noofvideos='4' and status='public' order by date  desc");
        ...
        $result=mysqli_query($con,"select * from videos where noofvideos='4' and status='public' order by date  desc limit ".$this_page_first_result.','.$result_per_page);
   ...
   <?php
        ...
        $result_per_page=10;
     $query=mysqli_query($con,"select * from videos where noofvideos='4' and status='public'  and restriction='under 18' order by date  desc");
     ...
     $result=mysqli_query($con,"select * from videos where noofvideos='4' and status='public'  and restriction='under 18' order by date  desc limit ".$this_page_first_result.','.$result_per_page);
...
<div class="row">
    ...
    if(!empty($_SESSION['id'])){
      if($age>=18){
        $result_per_page=10;
        $query=mysqli_query($con,"select * from videos where noofvideos='5' and status='public' order by date  desc");
        ...
        $result=mysqli_query($con,"select * from videos where noofvideos='5' and status='public' order by date  desc limit ".$this_page_first_result.','.$result_per_page);
     ...
     <?php
        ...
        $result_per_page=10;
        $query=mysqli_query($con,"select * from videos where noofvideos='5' and status='public' and restriction='under 18' order by date  desc");
        ...
        $result=mysqli_query($con,"select * from videos where noofvideos='5' and status='public' and restriction='under 18' order by date  desc limit ".$this_page_first_result.','.$result_per_page);
...
<div class="row">
    ...
    if(!empty($_SESSION['id'])){
      if($age>=18){
        $result_per_page=10;
    $query=mysqli_query($con,"select * from videos where noofvideos='6' and status='public' order by date  desc");
    ...
    $result=mysqli_query($con,"select * from videos where noofvideos='6' and status='public' order by date  desc limit ".$this_page_first_result.','.$result_per_page);
...
<?php
        ...
        $result_per_page=10;
    $query=mysqli_query($con,"select * from videos where noofvideos='6' and status='public'  and restriction='under 18' order by date  desc");
    ...
    $result=mysqli_query($con,"select * from videos where noofvideos='6' and status='public'  and restriction='under 18' order by date  desc limit ".$this_page_first_result.','.$result_per_page);
...
<div class="row">
  ...
  if(!empty($_SESSION['id'])){
    if($age>=18){
      $result_per_page=10;
    $query=mysqli_query($con,"select * from videos where noofvideos='7' and status='public' order by date  desc");
    ...
    $result=mysqli_query($con,"select * from videos where noofvideos='7' and status='public' order by date  desc limit ".$this_page_first_result.','.$result_per_page);
...
<?php
      ...
      $result_per_page=10;
    $query=mysqli_query($con,"select * from videos where noofvideos='7' and status='public' and restriction='under 18' order by date  desc");
    ...
    $result=mysqli_query($con,"select * from videos where noofvideos='7' and status='public' and restriction='under 18' order by date  desc limit ".$this_page_first_result.','.$result_per_page);
...
<div class="row">
    ...
    if(!empty($_SESSION['id'])){
      if($age>=18){
        $result_per_page=10;
        $query=mysqli_query($con,"select * from videos where noofvideos='8' and status='public' order by date  desc");
        ...
        $result=mysqli_query($con,"select * from videos where noofvideos='8' and status='public' order by date  desc limit " .$this_page_first_result.','.$result_per_page);
        if($result){
         while($row=mysqli_fetch_array($result)){
         $thumbnail=$row['thumbnail'];
         $user_id=$row['user_id'];
    ...
    <?php
        ...
        $result_per_page=10;
        $query=mysqli_query($con,"select * from videos where noofvideos='8' and status='public' and restriction='under 18' order by date  desc");
        ...
        $result=mysqli_query($con,"select * from videos where noofvideos='8' and status='public' and restriction='under 18' order by date  desc limit " .$this_page_first_result.','.$result_per_page);
        if($result){
         while($row=mysqli_fetch_array($result)){
         $thumbnail=$row['thumbnail'];
         $user_id=$row['user_id'];
